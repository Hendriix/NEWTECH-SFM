...
public class EncaissementTypeActivity extends AppCompatActivity {
    ...
    private static final String TAG = EncaissementTypeActivity.class.getSimpleName();
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        ArrayAdapter<Menu> mAdapterRapport = new ArrayAdapter<Menu>(EncaissementTypeActivity.this,android.R.layout.simple_list_item_1, Rapports3);
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
                ...
                if(ClickedMenu.getLIEN().toString().equals("ESPECE")){
                    ...
                    if(commande_source.equals("Livraison")){
                        valeur_encaissement_espece.setText(String.valueOf(EncaissementActivity.livraison.getMONTANT_NET()-getValEncaissement(EncaissementActivity.encaissements)));
                    }else{
                        valeur_encaissement_espece.setText(String.valueOf(EncaissementActivity.commande.getMONTANT_NET()-getValEncaissement(EncaissementActivity.encaissements)));
                    ...
                    terminer.setOnClickListener(new View.OnClickListener() {
                        ...
                        public void onClick(View v) {
                            ...
                            if(checkMontantEspece()){
                                ...
                                double somme = montant+EncaissementActivity.payecommande;
                                Log.d("encaissement", "onClick montant: "+montant);
                                Log.d("encaissement", "onClick payecommande: "+EncaissementActivity.payecommande);
                                Log.d("encaissement", "onClick somme: "+somme);
                                Encaissement encaissement = new Encaissement();
                                if(commande_source.equals("Livraison")){
                                     encaissement = new Encaissement(utilisateur,EncaissementActivity.livraison,"ESPECE",montant);
                                }else{
                                    encaissement = new Encaissement(utilisateur,EncaissementActivity.commande,"ESPECE",montant);
                                }
                                Log.d(TAG, "onClick: encaissement espece "+encaissement.toString());
                                EncaissementActivity.encaissements.add(encaissement);
                                dialog.dismiss();
                                Intent intent = new Intent(EncaissementTypeActivity.this , EncaissementActivity.class);
                    ...
                    spinner_banque_adapter = new Spinner_Banque_Adapter(EncaissementTypeActivity.this,items);
                    ...
                    if(commande_source.equals("Livraison")){
                        valeur_encaissement_cheque.setText(String.valueOf(getNumberRounded(EncaissementActivity.livraison.getMONTANT_NET()-getValEncaissement(EncaissementActivity.encaissements))));
                    }else{
                        valeur_encaissement_cheque.setText(String.valueOf(getNumberRounded(EncaissementActivity.commande.getMONTANT_NET()-getValEncaissement(EncaissementActivity.encaissements))));
                    }
                    ...
                    terminer.setOnClickListener(new View.OnClickListener() {
                        ...
                        public void onClick(View v) {
                            ...
                            if(checkNumCheque() && checkMontantCheque() && checkImage()){
                                ...
                                Encaissement encaissement = new Encaissement();
                                if(commande_source.equals("Livraison")){
                                    encaissement = new Encaissement(utilisateur,EncaissementActivity.commande,"CHEQUE",montant,banque,num_cheque,"DEFAULT",encoded_image_cheque);
                    ...
                    //dialog.show();
                    Toast.makeText(EncaissementTypeActivity.this,"En cours de développement",Toast.LENGTH_LONG).show();
                    ...
                    Double montant_credit = creditManager.getSumResteCredit() + getValEncaissementCredit(EncaissementActivity.encaissements);
                    ...
                    if(commande_source.equals("Livraison")){
                        valeur_encaissement_credit.setText(String.valueOf(getNumberRounded(EncaissementActivity.livraison.getMONTANT_NET()-getValEncaissement(EncaissementActivity.encaissements))));
                    }else{
                        valeur_encaissement_credit.setText(String.valueOf(getNumberRounded(EncaissementActivity.commande.getMONTANT_NET()-getValEncaissement(EncaissementActivity.encaissements))));
                    }
                    ...
                    echeance.setOnClickListener(new View.OnClickListener() {
                        ...
                        public void onClick(View view) {
                            ...
                            date_echeance_picker = new DatePickerDialog(EncaissementTypeActivity.this, new DatePickerDialog.OnDateSetListener() {
                                @Override
                    ...
                    terminer.setOnClickListener(new View.OnClickListener() {
                        ...
                        public void onClick(View v) {
                            ...
                            if(checkMontantCredit() && checkCreditEcheance()){
                                ...
                                Encaissement encaissement = new Encaissement();
                                if(commande_source.equals("Livraison")){
                                    encaissement = new Encaissement(utilisateur,EncaissementActivity.livraison,"CREDIT",montant,0,credit_echeance);

                                }else{
                                    encaissement = new Encaissement(utilisateur,EncaissementActivity.commande,"CREDIT",montant,0,credit_echeance);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch (item.getItemId()) {
            ...
            case R.id.logout:
                ...
                editor.clear();
                editor.commit();
                Intent i = new Intent(EncaissementTypeActivity.this, AuthActivity.class);
            ...
            case R.id.option2:
                /*Intent intt = new Intent(EncaissementTypeActivity.this, PrintActivity2.class);
    ...
    public void onBackPressed() {
        super.onBackPressed();
        Intent i = new Intent(EncaissementTypeActivity.this, EncaissementActivity.class);
        startActivity(i);
        finish();
    }
    ...
    private void captureImage() {
        ...
        fileUri = FileProvider.getUriForFile(EncaissementTypeActivity.this,
                BuildConfig.APPLICATION_ID + ".provider",
                getOutputMediaFile(MEDIA_TYPE_IMAGE));
        intent.putExtra(MediaStore.EXTRA_OUTPUT, fileUri);
        // start the image capture Intent
        EncaissementTypeActivity.this.startActivityForResult(intent, CAMERA_CAPTURE_IMAGE_REQUEST_CODE);
    }
    ...
    private boolean checkCreditEcheance() {
        ...
        String date_credit = df2.format(new java.util.Date());
