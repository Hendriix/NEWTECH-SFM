...
public class ViewChargementActivity extends AppCompatActivity{
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        if(stockDemandeLignes!=null){
            ...
            stockDemandeLigneManager.fixSDLigneCode(stockDemandeLignes);
        ...
        valider.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(final View view) {
                ...
                if((stockDemande!=null && commandeSource.equals("TP0024") && stockDemandeLignes.isEmpty()==false) || (stockDemande!=null && commandeSource.equals("TP0025") && stockDemandeLignes.isEmpty()==false)){


                    for(int i=0;i<stockDemandeLignes.size();i++){
                        stockDemandeLigneManager.add(stockDemandeLignes.get(i));
                    }
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        switch (item.getItemId()) {
            ...
            case R.id.plus:
                ...
                if(stockDemande==null){
                    new AlertDialog.Builder(ViewChargementActivity.this)
                    ...
                    Intent intent = new Intent(this, ChargementPanierActivity.class);
                    startActivity(intent);
                    finish();


                    //Toast.makeText(ViewChargementActivity.this,"CREATION CHARGEMENT",Toast.LENGTH_LONG).show();
                    return true;
                }
