...
import com.newtech.newtech_sfm.Configuration.RvAvoirAdapter;
            ...
            public void onClick(final View view) {
                ...
                if(list!=null) {
                    ...
                    if(isNetworkAvailable()){
                        ...
                        Toast.makeText(PanierAvoirActivity.this,"Vérifier votre connexion internet puis synchroniser",Toast.LENGTH_LONG).show();
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        switch (item.getItemId()) {
            ...
            case R.id.plus:
                ...
                Intent intent = new Intent(this, SelectArticleAvoirActivity.class);
                //intent.putExtra("TOURNEE_CODE",tournee_Code);
