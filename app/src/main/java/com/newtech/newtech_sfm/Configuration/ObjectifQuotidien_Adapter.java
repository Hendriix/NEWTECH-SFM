...
public class ObjectifQuotidien_Adapter extends BaseAdapter{

    private Activity activity;
    private LayoutInflater inflater;
    private List<ObjectifRow> objectifrows;

    public ObjectifQuotidien_Adapter(Activity activity, List<ObjectifRow> objectifrows) {
    ...
    public Object getItem(int position) {
        return objectifrows.get(position);
    }
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null)
            convertView = inflater.inflate(R.layout.objectif_quotidien_row, null);

        TextView tv_famille = (TextView) convertView.findViewById(R.id.lobjQ_famille_tv);
        TextView tv_objectif = (TextView) convertView.findViewById(R.id.lobjQ_objectif_tv);
        TextView tv_realisation = (TextView) convertView.findViewById(R.id.lobjQ_realisation_tv);
        TextView tv_percent = (TextView) convertView.findViewById(R.id.lobjQ_percent_tv);
        CircularProgressBar circular = (CircularProgressBar) convertView.findViewById(R.id.lobjQ_progressBar2);
