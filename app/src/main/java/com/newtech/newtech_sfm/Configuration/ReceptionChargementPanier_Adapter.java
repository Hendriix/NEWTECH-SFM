...
import com.newtech.newtech_sfm.Activity.ViewReceptionChargementActivity;
...
public class ReceptionChargementPanier_Adapter extends BaseAdapter{
    ...
    public ReceptionChargementPanier_Adapter(Activity activity, List<Article> articleLists, Context context) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if(stockDemandeLignes.size()>0){
            ...
            Unite_StockDemandeReception_Adapter unite_stockDemandeReception_adapter = new Unite_StockDemandeReception_Adapter(activity,stockDemandeLigneArrayList,context);
            uniteListView = (ListView) convertView.findViewById(R.id.unite_listview1);
            uniteListView.setAdapter(unite_stockDemandeReception_adapter);
