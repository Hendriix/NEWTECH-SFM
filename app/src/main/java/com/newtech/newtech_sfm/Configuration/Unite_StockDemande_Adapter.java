...
public class Unite_StockDemande_Adapter extends BaseAdapter{
    ...
    public Unite_StockDemande_Adapter(Activity activity, List<StockDemandeLigne> stockDemandeLignes, Context context) {
    ...
    public Object getItem(int position) {
        return stockDemandeLignes.get(position);
    }
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        String article_code = stockDemandeLignes.get(position).getARTICLE_CODE();
        String article_unite = stockDemandeLignes.get(position).getUNITE_CODE();
        String base64Image1 = "";
        unite = uniteManager.getByACUC(article_code,article_unite);

        quantite_unite.setText(String.valueOf(stockDemandeLignes.get(position).getQTE_COMMANDEE()));
