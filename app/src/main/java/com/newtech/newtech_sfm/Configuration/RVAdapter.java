...
import com.newtech.newtech_sfm.Activity.PanierActivity;
import com.newtech.newtech_sfm.Activity.SelectArticleActivity;
...
public class RVAdapter extends RecyclerView.Adapter<RVAdapter.PersonViewHolder>{
    ...
    public RVAdapter(List<Article> persons){
    ...
    public PersonViewHolder onCreateViewHolder(ViewGroup viewGroup, int i) {
        View v = LayoutInflater.from(viewGroup.getContext()).inflate(R.layout.list_cell2, viewGroup, false);
       ...
       if( clientCourant!=null){
        ...
        personViewHolder.itemView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(final View view) {
                ...
                if(RVAdapter.currentActivity.equals("SelectionActivity")) {

                    final Dialog dialog = new Dialog(personViewHolder.itemView.getContext());
                    dialog.setContentView(R.layout.alert_dialog_vente);
                    ...
                    addPanierButton.setOnClickListener(new View.OnClickListener() {
                        ...
                        public void onClick(View v) {
                           ...
                           double prixArticle = articlePrix.getARTICLE_PRIX();
                            ...
                            String  s= SelectArticleActivity.total.getText().toString();
                            s = s.replace(",", "");
                            try
                            {
                            ...
                            SelectArticleActivity.total.setText(String.valueOf(new DecimalFormat("##.###").format(totalPrix)));
                            ...
                            */
                            ...
                            if(SelectArticleActivity.dropdown.getSelectedItem().toString().equals("tous"))
                            SelectArticleActivity.listArticleParFamilleCode.put("tous",articles);
                            else
                            SelectArticleActivity.listArticleParFamilleCode.put(SelectArticleActivity.dropdown.getSelectedItem().toString(),articles);
                            personViewHolder.nbr_de_vente.setText(String.valueOf(nbr));
                            Intent i = new Intent(view.getContext(), SelectArticleActivity.class)
                            .setFlags(Intent.FLAG_ACTIVITY_NEW_TASK);
                            view.getContext().startActivity(i);

                            SelectArticleActivity.terminer.setOnClickListener(new View.OnClickListener() {
                                @Override
                                public void onClick(final View view) {
                                    ...
                                    editor.commit();
                                    Intent i = new Intent(view.getContext(), PanierActivity.class)
                                    .setFlags(Intent.FLAG_ACTIVITY_NEW_TASK);
                                    view.getContext().startActivity(i);
