...
public class Unite_StockDemandeReception_Adapter extends BaseAdapter{
    ...
    public Unite_StockDemandeReception_Adapter(Activity activity, List<StockDemandeLigne> stockDemandeLignes, Context context) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        quantite_unite.setText(String.valueOf(stockDemandeLignes.get(position).getQTE_LIVREE()));
