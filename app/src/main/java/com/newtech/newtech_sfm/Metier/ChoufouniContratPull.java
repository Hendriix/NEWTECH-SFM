...
public class ChoufouniContratPull{
    ...
    public ChoufouniContratPull() {
    }

    public ChoufouniContratPull(String CHOUFOUNI_CONTRAT_CODE, String CHOUFOUNI_CODE, String DISTRIBUTEUR_CODE, String UTILISATEUR_CODE, String CLIENT_CODE, String DATE_CONTRAT, String TYPE_CODE, String STATUT_CODE, String CATEGORIE_CODE, double REMISE, double SOLDE, String CREATEUR_CODE, String DATE_CREATION, String COMMENTAIRE, String VERSION, String GPS_LATITUDE, String GPS_LONGITUDE, int DISTANCE) {
    ...
    public ChoufouniContratPull(JSONObject choufouniContrat) {
